...
log_dir = '/content/drive/Shared drives/DNN/Deep-Image-Matting/logs_2'
checkpoint_models_path = '/content/drive/Shared drives/DNN/Deep-Image-Matting/checkpoints_2/'
