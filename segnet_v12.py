...
# light xception aligned ASPP 31M
...
def build_encoder_decoder():
    ...
    conv_4_3x3_4 = SeparableConv2D(256, (kernel, kernel), activation='relu', padding='same', dilation_rate=ATROUS_RATES[3], name='conv4_3x3_4')(x)   
