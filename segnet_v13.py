...
def build_encoder_decoder():
    ...
    conv_4_3x3_1 = Conv2D(256, (3, 3), activation='relu', padding='same', dilation_rate=ATROUS_RATES[0], name='conv4_3x3_1')(x)
    conv_4_3x3_2 = Conv2D(256, (3, 3), activation='relu', padding='same', dilation_rate=ATROUS_RATES[1], name='conv4_3x3_2')(x)
    conv_4_3x3_3 = Conv2D(256, (3, 3), activation='relu', padding='same', dilation_rate=ATROUS_RATES[2], name='conv4_3x3_3')(x)
    conv_4_3x3_4 = Conv2D(256, (3, 3), activation='relu', padding='same', dilation_rate=ATROUS_RATES[3], name='conv4_3x3_4')(x)
    ...
    # Concat
    x = Concatenate(axis=3)([conv_4_1x1, conv_4_3x3_1, conv_4_3x3_2, conv_4_3x3_3, conv_4_3x3_4, image_level_features])
    x = Conv2D(256, (3,3), activation='relu', padding='same', name='conv_1x1_1_concat')(x)
    x = Conv2D(512, (3,3), activation='relu', padding='same', name='conv_1x1_2_concat')(x)
    orig_4 = x
    x = MaxPooling2D((2, 2), strides=(2, 2))(x)
